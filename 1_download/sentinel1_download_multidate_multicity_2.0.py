...
cityrois = '/home/hpc/pr84ya/ga39lev3/So2Sat/LCZ29'
...
outdir = '/naslx/projects/pr84ya/lu32hug4/DATA/Sentinel-1'
...
for city in cityname:
    ...
    if roiType.lower() == 'kml':
        ...
        kmlpath = cityrois + '/' + city + '/' + city + '_roi.kml'
        ...
        # directory to the ROI.kml file
        tifpath = cityrois + '/' + city + '/' + city + '_lcz_GT.tif'
    ...
    for tt in range(0,len(startDate)):
        ...
        if targetData.empty:
            ...
            print('orbit direction: '+ targetData.iloc[0]['orbitdirection'])        
            logging.info('orbit direction: '+ targetData.iloc[0]['orbitdirection']) 
